...
from clean_data import default_columns, cleaned_columns, country_to_cca3, dict_countries_to_cca3
...
def load_data():
    ...
    if not os.path.isfile('../data/final_data.csv'):
        #fetching
        print("If you see this and you are not expecting to download and clean all the data, please verify you have the file final_data.csv in the folder data")
